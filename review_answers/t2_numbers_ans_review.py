...
print(f"Addition results: {num1 + num2}")
print(f"Substraction results:  {num1 - num2}")
print(f"Multiplication results:  {num1 * num2}")
print(f"Division results (first number / second number): {num1/num2}")
