...
# 9. Use `.replace()` to replace `Rihana` to `BTS`, replace 'my' with 'her' in `favourite_artist` variable
#    so the value of the variable will be changed to 'BTS is her favourite artise'
